...
// * - Index updates
// *
// * NOTE: This requires a running registry at the configured URL. Results will vary based on
// network
...
//
//  /**
//   * Benchmark: 3 concurrent pulls of the same image. Tests coordinator efficiency - only one
// should
...
//
//  /**
//   * Benchmark: Pull with existing content (cache hit). Tests how fast the system detects and
// skips
