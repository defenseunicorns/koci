...
/**
 * Tracks in-progress downloads to prevent concurrent downloads of the same descriptor.
 * The Int value represents the number of active operations using this mutex.
 */
