...
class Router(registryURL: String) {
     ...
     *
     * Handles both absolute and relative URLs according to RFC 7231 section 7.1.2.
     * For relative URLs, resolves them against the registry base URL.
     *
     * @param locationHeader Location header value from HTTP response
     * @see <a href="https://datatracker.ietf.org/doc/html/rfc7231#section-7.1.2">RFC 7231: Location</a>
     */
