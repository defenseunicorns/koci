...
/**
 * Free-form string map carried by manifests, indexes, and descriptors. See the OCI spec for
 * [predefined annotation keys](https://github.com/opencontainers/image-spec/blob/main/annotations.md#pre-defined-annotation-keys).
 */
