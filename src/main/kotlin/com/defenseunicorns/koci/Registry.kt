...
class Registry(
     ...
     *
     * Performs a GET request to the /v2/ endpoint as specified in the OCI Distribution
     * Specification. A successful response indicates the registry implements the API
     * and the client is authorized to access it.
     *
     * @see <a href="https://github.com/opencontainers/distribution-spec/blob/main/spec.md#determining-support">OCI Distribution Spec: API Version Check</a>
     */
     ...
     *
     * @see <a href="https://github.com/opencontainers/distribution-spec/tree/main/extensions">OCI Distribution Spec: Extensions</a>
     */
    inner class Extensions {
         ...
         *
         * @see <a href="https://github.com/opencontainers/distribution-spec/blob/main/spec.md#listing-tags">OCI Distribution Spec: Listing Repositories</a>
         */
         ...
         * @see <a href="https://github.com/opencontainers/distribution-spec/blob/main/spec.md#listing-tags">OCI Distribution Spec: Pagination</a>
         *
 ...
 *
 * This extension function provides access to repository-specific operations
 * such as tag listing, content pushing/pulling, and manifest operations.
 *
 ...
 * @see <a href="https://github.com/opencontainers/distribution-spec/blob/main/spec.md#listing-tags">OCI Distribution Spec: Listing Image Tags</a>
 */
 ...
 * @see <a href="https://github.com/opencontainers/distribution-spec/blob/main/spec.md#pull">OCI Distribution Spec: Existing Manifests</a>
 */
 ...
 *
 * Resolves the tag to a descriptor, then pulls the manifest and all referenced
 * content. For multi-platform images, the platformResolver can be used to select
 * a specific platform.
 *
 * @param repository Repository name
